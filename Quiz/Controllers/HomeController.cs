    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string presidentInput, string playerInput, string personInput, string tennisInput)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string result = $"<div class=\"p-2\"><p>You got {correct} answers correct</p><p>Here are the correct answers:</p><p>{president} is the president of United States</p><p>{player} has most international goals in football</p><p>{person} is the richest person in the world</p><p>{tennis} has won most Grand Slam titles in tennis</p></div>";
